...
# @file TTP.pm
#
# @brief Test Suite TCP throughput.
#
#
...
our $test_suite_tcp_tp = 
    [
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp --dontwarmup',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -b10',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -b100',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -b1000',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -t10',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -t30',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -m32',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -m4096',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -m65500',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -r10',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -r100',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            server_arg => 'sr -i TARGET() --tcp',
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -i TARGET() --tcp -r1024',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:10)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:10) -F s',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:10) -F p',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:10) -F e',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:300) -F s',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:300) -F p',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using poll()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:300) -F e',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using epoll()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:3) -F s --timeout 0',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:3) -F p --timeout 0',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using poll()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:3) -F e --timeout 0',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using epoll()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:3) -F s --timeout=-1',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:3) -F p --timeout=-1',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using poll()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:3) -F e --timeout=-1',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using epoll()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:2)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:20)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'tp -f FEED(TCP:TARGET():17000:400)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit', 'using select()'],
