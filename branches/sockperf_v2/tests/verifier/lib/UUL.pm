...
# @file UUL.pm
#
# @brief Test Suite UDP under-load.
#
#
...
our $test_suite_udp_ul = 
    [
	    ...
	    },
        {
            ...
            server_arg => 'sr -i TARGET()',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -i TARGET() --dontwarmup',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:10)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:10) -F s',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:10) -F p',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:10) -F e',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:300) -F s',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:300) -F p',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:300) -F e',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:3) -F s --timeout 0',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:3) -F p --timeout 0',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:3) -F e --timeout 0',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:3) -F s --timeout=-1',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:3) -F p --timeout=-1',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:3) -F e --timeout=-1',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:2)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:20)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        },
        {
            ...
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:TARGET():17000:400)',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc36',
            note => '#36 - under-load multicast option -f --mc-loopback-enable',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:10) -F s',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:10) -F s --mc-loopback-enable',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc37',
            note => '#37 - under-load multicast option -f -Fs (10 records)',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:10) -F s',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:10) -F s',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc38',
            note => '#38 - under-load multicast option -f -Fp (10 records)',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:10) -F p',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:10) -F p',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc39',
            note => '#39 - under-load multicast option -f -Fe (10 records)',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:10) -F e',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:10) -F e',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc40',
            note => '#40 - under-load multicast option -f -Fs (300 records)',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:300) -F s',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:300) -F s',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc41',
            note => '#41 - under-load multicast option -f -Fp (300 records)',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:300) -F p',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:300) -F p',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc42',
            note => '#42 - under-load multicast option -f -Fe (300 records)',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -f FEED(UDP:224.4.0.3:17000:300) -F e',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -f FEED(UDP:224.4.0.3:17000:300) -F e',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc43',
            note => '#43 - under-load option --pps=10',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -i TARGET()',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -i TARGET() --pps=10',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc44',
            note => '#44 - under-load option --pps=1000',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -i TARGET()',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -i TARGET() --pps=1000',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc45',
            note => '#45 - under-load option --pps=100000',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -i TARGET()',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -i TARGET() --pps=100000',
            result_proc => \&te_def_result_proc,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
        ...
        {
            name => 'tc46',
            note => '#46 - under-load option --pps=100 --reply-every=100',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -i TARGET()',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -i TARGET() --pps=100 --reply-every=100',
            result_proc => \&te_uul_result_proc1,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
                    failure => ['Segmentation fault', 'Assertion', 'ERROR']
        ...
        {
            name => 'tc47',
            note => '#47 - under-load option --pps=1000 --reply-every=10',
            pre_proc => \&te_def_pre_proc,
            server_proc => \&te_def_server_proc,
            server_arg => 'sr -i TARGET()',
            client_proc => \&te_def_client_proc,
            client_arg => 'ul -i TARGET() --pps=1000 --reply-every=10',
            result_proc => \&te_uul_result_proc2,
            result_arg => {
                server => {
                    success => ['Test end', 'interrupted by', 'exit'],
                    failure => ['Segmentation fault', 'Assertion', 'ERROR']
